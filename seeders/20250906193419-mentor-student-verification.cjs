...
module.exports = {
  async up (queryInterface, Sequelize) {
    await queryInterface.bulkInsert('MentorStudentVerifications', [
      ...
      { studentId: 6, mentorId: 1, status: 'approved', createdAt: new Date(), updatedAt: new Date() },
      ...
      { studentId: 7, mentorId: 2, status: 'approved', createdAt: new Date(), updatedAt: new Date() },
      ...
      { studentId: 3, mentorId: 3, status: 'approved', createdAt: new Date(), updatedAt: new Date() },
      ...
      { studentId: 9, mentorId: 4, status: 'approved', createdAt: new Date(), updatedAt: new Date() },
      ...
      { studentId: 5, mentorId: 5, status: 'approved', createdAt: new Date(), updatedAt: new Date() },
      ...
      { studentId: 20, mentorId: 5, status: 'approved', createdAt: new Date(), updatedAt: new Date() }
    ], {});
  },
